...
export ZSH="/Users/seanammirati/.oh-my-zsh"

## conda completion
fpath+=/Users/seanammirati/.oh-my-zsh/custom/plugins/conda-zsh-completion
...
plugins=(web-search git zsh-syntax-highlighting zsh-autosuggestions colorize iterm2 osx python pip brew docker vi-mode aws zsh-completions)
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/Users/seanammirati/opt/anaconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/Users/seanammirati/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/seanammirati/opt/anaconda3/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/Users/seanammirati/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda init <<<
